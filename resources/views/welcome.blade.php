...
@section('content')
    ...
    <form action="" method="POST" class="absolute z-[9999] top-5 right-5">
        ...
        <!-- Informasi Legend -->
        <div id='loading' class="absolute inset-0 hidden items-center justify-center z-[999] bg-gray-900 opacity-50 h-screen w-screen">
    ...
    <div x-data="dataOrdinal">
        <button class="absolute p-3 rounded-xl top-5 left-5 z-[9999] text-sm bg-gray-600 text-gray-100" x-on:click="showProperty()">Tampilkan Property</button>
        <div class="legend bottom-[10%] left-5 bg-white fixed w-[300px] h-[300px] z-[999] flex flex-col justify-center gap-1 pl-5 rounded-lg">
